Coding Languages and Their Most Common Use Cases (by ChatGPT):
    ...
    General-Purpose Languages
        ...
        C++         Game development, high-performance applications, operating systems, desktop applications
        Java        Backend development, enterprise applications, Android development, game development
        Python      Data science, AI/ML, web development, automation, scripting, cybersecurity
        C#          Game development (Unity), desktop applications, backend development (ASP.NET)
        Rust        Systems programming, security-focused applications, embedded systems, blockchain
