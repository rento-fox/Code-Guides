...
a = 'Jane'
print('My name is ' + a) # My name is Jane

# Add Two String Variables Together
a = 'Jane'
b = 'My name is '
print(b + a) # My name is Jane
...
a = 2
b = 3
print('a is ' + str(a) + ', and b is ' + str(b)) # a is 2, and b is 3
c = a + b
...
temperature = 25
print('Temperature: ' + str(temperature) + '°C') # Temperature: 25°C
if temperature > 20:
